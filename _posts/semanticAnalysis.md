...
The lexer output for this expression as stated in the [previous Lexical Analysis post](/posts/lexicalAnalysis) would be:
...
A parse tree for this expression also stated in the [previous Syntax Analysis post](/posts/syntaxAnalysis) would have the following structure:
```
                         =
                        / \
                       x   +
