...
const navigation = {
  ...
  social: [
    {
      name: 'LinkedIn',
      href: 'https://www.linkedin.com/in/jennifer-chukwu-kelechi/',
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
            d="38.2336851 C40,39.2090082 39.2093333,40 38.234,40 L9.76633333,40 Z"
          clipRule="evenodd"
          />
        </svg>
      ),
    ...
    {
      name: 'Instagram',
      href: 'https://www.instagram.com/jnyfah_chukwu/',
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    {
      name: 'Twitter',
      href: 'https://twitter.com/jennifachukwu',
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
